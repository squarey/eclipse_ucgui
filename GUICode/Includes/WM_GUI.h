...
#ifndef UC_WM_GUI_H            /* Make sure we only include it once */
#define UC_WM_GUI_H
...
I32       WM__InitIVRSearch(const GUI_RECT* pMaxRect);
I32       WM__GetNextIVR   (void);
I32       WM__GetOrgX_AA(void);
I32       WM__GetOrgY_AA(void);
