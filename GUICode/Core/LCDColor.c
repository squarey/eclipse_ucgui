...
LCD_PIXELINDEX* LCD_GetpPalConvTableUncached(const LCD_LOGPALETTE GUI_UNI_PTR *  pLogPal) {
  ...
  {
    I32 i;
    I32 NumEntries = pLogPal->NumEntries;
...
void LCD_InitLUT(void) {
    ...
    {
      I32 i;
      I32 DisplayOld = GUI_SelectLayer(1);
    ...
    {
      I32 i;
      I32 DisplayOld = GUI_SelectLayer(2);
    ...
    {
      I32 i;
      I32 DisplayOld = GUI_SelectLayer(3);
    ...
    {
      I32 i;
      I32 DisplayOld = GUI_SelectLayer(4);
