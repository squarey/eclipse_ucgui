...
*       _DrawBitline
*/
static void _DrawBitline(I32 x0, I32 y0, I32 xsize, I32 BPP, const U8*pData, I32 Diff, const LCD_PIXELINDEX* pTrans) {
  union {
  ...
  I32 i;
  I32 NumPixels;
  I32 NumPixelsMax = sizeof(Buffer.ab)*8/BPP/LCD_XMAG;
  while (xsize >0) {
    I32 iOff =0;
...
void LCD_L0_MAG_DrawBitmap(I32 x0, I32 y0, I32 xsize, I32 ysize,
                           I32 BPP, I32 BytesPerLine, const U8* pData, I32 Diff,
...
*/
void LCD_L0_MAG_DrawVLine(I32 x0 , I32 y0,  I32 y1) {
  y0 *= LCD_YMAG;
...
*/
void LCD_L0_MAG_SetPixelIndex(I32 x, I32 y, I32 ColorIndex) {
  I32 ix, iy;
  y *= LCD_YMAG;
  x *= LCD_XMAG;
