...
#ifndef UC_LCD_Private_H
#define UC_LCD_Private_H
...
const tLCDDEV_APIList* LCD_SetAPI      (const tLCDDEV_APIList* pAPI, I32 Index);
const tLCDDEV_APIList* LCD_SetAPIForAll(const tLCDDEV_APIList* pAPI, I32 Index);
...
void LCD_DrawBitmap   (I32 x0, I32 y0,
                       I32 xsize, I32 ysize,
                       I32 xMul, I32 yMul,
                       I32 BitsPerPixel,
                       I32 BytesPerLine,
...
void LCD_UpdateColorIndices(void);
  ...
  void LCD_ReadRect(I32 x0, I32 y0, I32 x1, I32 y1, LCD_PIXELINDEX * pBuffer, const tLCDDEV_APIList * pAPI);
#endif
