...
*/
I32 DROPDOWN__GetNumItems(DROPDOWN_Obj* pObj) {
...
*/
static WM_HMEM _GethItem(DROPDOWN_Obj* pObj, I32 Index) {
...
*       _DrawTriangleDown
*/
static void _DrawTriangleDown(I32 x, I32 y, I32 Size) {
  for (; Size >= 0; Size--, y++ ) {
...
*/
static const char* _GetpItem(DROPDOWN_Obj* pObj, I32 Index) {
  const char* s = NULL;
...
*       _SelectByKey
*/
static void _SelectByKey(DROPDOWN_Handle hObj, I32 Key) {
  I32 i;
  DROPDOWN_Obj* pObj;
...
*       _OnTouch
*/
static I32 _OnTouch(DROPDOWN_Handle hObj, WM_MESSAGE*pMsg) {
