...
#if GUI_WINSUPPORT && MENU_SUPPORT
...
*/
static void _GetTopLevelMenu(MENU_Handle hObj, MENU_Obj * pObj, MENU_Handle * phObjTopLevel, MENU_Obj ** ppObjTopLevel, I32 * pSubSel) {
...
*       _HasEffect
*/
static I32 _HasEffect(MENU_Handle hObj, MENU_Obj* pObj) {
...
*       _GetEffectSize
*/
static I32 _GetEffectSize(MENU_Handle hObj, MENU_Obj* pObj) {
  I32 r = 0;
...
*       _CalcTextWidth
*/
static I32 _CalcTextWidth(MENU_Obj* pObj, const char GUI_UNI_PTR* sText) {
  I32 TextWidth = 0;
  if (sText) {
...
*       _GetItemWidth
*/
static I32 _GetItemWidth(MENU_Handle hObj, MENU_Obj* pObj, unsigned Index) {
  I32 ItemWidth;
...
*       _GetItemHeight
*/
static I32 _GetItemHeight(MENU_Handle hObj, MENU_Obj* pObj, unsigned Index) {
  I32 ItemHeight;
...
*       _CalcMenuSizeX
*/
static I32 _CalcMenuSizeX(MENU_Handle hObj, MENU_Obj* pObj) {
...
*       _CalcMenuSizeY
*/
static I32 _CalcMenuSizeY(MENU_Handle hObj, MENU_Obj* pObj) {
  unsigned i, NumItems = MENU__GetNumItems(pObj);
  I32 ySize = 0;
  if (pObj->Flags & MENU_SF_VERTICAL) {
    for (i = 0; i < NumItems; i++) {
...
*       _CalcWindowSizeX
*/
static I32 _CalcWindowSizeX(MENU_Handle hObj, MENU_Obj* pObj) {
  I32 xSize = pObj->Width;
  if (xSize == 0) {
...
*       _CalcWindowSizeY
*/
static I32 _CalcWindowSizeY(MENU_Handle hObj, MENU_Obj* pObj) {
  I32 ySize = pObj->Height;
  if (ySize == 0) {
...
*/
static I32 _GetItemFromPos(MENU_Handle hObj, MENU_Obj* pObj, I32 x, I32 y) {
  I32 xSize, ySize, EffectSize, r = -1;
  ySize = _CalcMenuSizeY(hObj, pObj);
...
*       _GetItemPos
*/
static void _GetItemPos(MENU_Handle hObj, MENU_Obj* pObj, unsigned Index, I32* px, I32* py) {
  I32 i, EffectSize;
  EffectSize = _GetEffectSize(hObj, pObj);
  if (pObj->Flags & MENU_SF_VERTICAL) {
    I32 yPos = 0;
    for (i = 0; i < (I32)Index; i++) {
      yPos += _GetItemHeight(hObj, pObj, i);
    }
    *px = EffectSize;
    *py = EffectSize + yPos;
...
*       _SetSelection
*/
static void _SetSelection(MENU_Handle hObj, MENU_Obj* pObj, I32 Index) {
  if (Index != pObj->Sel) {
    pObj->Sel = Index;
...
*/
static char _HandlePID(MENU_Handle hObj, MENU_Obj* pObj, I32 x, I32 y, I32 Pressed) {
...
*       _SetPaintColors
*/
static void _SetPaintColors(const MENU_Obj* pObj, const MENU_ITEM* pItem, I32 ItemIndex) {
  char Selected;
  unsigned ColorIndex;
...
static void _OnPaint(MENU_Handle hObj, MENU_Obj* pObj) {
  ...
  I32 FontHeight  = GUI_GetYDistOfFont(pObj->Props.pFont);
  I32 EffectSize  = _GetEffectSize(hObj, pObj);
...
*/
static void _MoveSel(MENU_Handle hObj, I32 Dir) {
  MENU_Obj * pObj;
  I32 NewIndex, Index, NumItems, Cnt = 0;
...
*       _OpenMenu
*/
static void _OpenMenu(MENU_Handle hObj, MENU_Obj * pObj, I32 Index, I32 SubSel) {
  MENU_ITEM * pItem;
  MENU_Obj  * pSubObj;
  pItem = (MENU_ITEM *)GUI_ARRAY_GetpItem(&pObj->ItemArray, Index);
  pObj->Flags |= MENU_SF_ACTIVE;
...
*       _OnKey
*/
static I32 _OnKey(MENU_Handle hObj, MENU_Obj * pObj, I32 Key) {
  I32 KeyOpen, KeyBack, KeyNext, KeyPrev, Index, SubSel = 0;
  MENU_ITEM * pItem;
  MENU_Handle hObjTopLevel;
  MENU_Obj * pObjTopLevel;
  Index = pObj->Sel;
...
void MENU_Callback(WM_MESSAGE* pMsg) {
  MENU_Handle hObj;
  MENU_Obj* pObj;
  I32 OldWidgetState, Result, HasFocus;
  hObj = pMsg->hWin;
...
*       MENU_CreateEx
*/
MENU_Handle MENU_CreateEx(I32 x0, I32 y0, I32 xSize, I32 ySize, WM_HWIN hParent, I32 WinFlags, I32 ExFlags, I32 Id) {
  MENU_Handle hObj;
  /* Create the window */
  WM_LOCK();
...
char MENU__SetItem(MENU_Handle hObj, MENU_Obj* pObj, unsigned Index, const MENU_ITEM_DATA* pItemData) {
  ...
  if (GUI_ARRAY_SetItem(&pObj->ItemArray, Index, &Item, sizeof(MENU_ITEM) + GUI_strlen(pText)) != 0) {
    MENU_ITEM* pItem = (MENU_ITEM*)GUI_ARRAY_GetpItem(&pObj->ItemArray, Index);
    GUI_strcpy(pItem->acText, pText);
...
*/
I32 MENU__SendMenuMessage(MENU_Handle hObj, WM_HWIN hDestWin, U16 MsgType, U16 ItemId) {
