...
MENU_Handle MENU_CreateIndirect(const GUI_WIDGET_CREATE_INFO* pCreateInfo, WM_HWIN hWinParent, I32 x0, I32 y0, WM_CALLBACK* cb);
...
void      MENU_Attach           (MENU_Handle hObj, WM_HWIN hDestWin, I32 x, I32 y, I32 xSize, I32 ySize, I32 Flags);
void      MENU_Popup            (MENU_Handle hObj, WM_HWIN hDestWin, I32 x, I32 y, I32 xSize, I32 ySize, I32 Flags);
