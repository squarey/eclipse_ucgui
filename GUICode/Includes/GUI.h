...
#define GUI_INVALID_COLOR 0xFFFFFF      /* Invalid color - more than 24 bits */
...
extern U8 LOG_OPEN;
#define GUI_Debug(...)    		if(LOG_OPEN == 1)(GUI_LOG_OUT("MSG:%s->L%d(%s):", __FILE__, __LINE__, __func__),GUI_LOG_OUT(__VA_ARGS__))
...
I32  GUI_RectsIntersect(const GUI_RECT* pr0, const GUI_RECT* pr1);
void GUI_MoveRect       (GUI_RECT *pRect, I32 x, I32 y);
void GUI_MergeRect      (GUI_RECT* pDest, const GUI_RECT* pr0, const GUI_RECT* pr1);
I32  GUI__IntersectRects(GUI_RECT* pDest, const GUI_RECT* pr0, const GUI_RECT* pr1);
void GUI__IntersectRect (GUI_RECT* pDest, const GUI_RECT* pr0);
void GUI__ReduceRect    (GUI_RECT* pDest, const GUI_RECT *pRect, I32 Dist);
...
I32  GUI__DivideRound     (I32 a, I32 b);
I32  GUI__DivideRound32   (I32 a, I32 b);
I32  GUI__SetText(GUI_HMEM* phText, const char* s);
...
void      GUI_SetBkColorIndex(I32 Index);
void      GUI_SetColorIndex(I32 Index);
...
I32       GUI_Color2Index(GUI_COLOR color);
GUI_COLOR GUI_Color2VisColor(GUI_COLOR color);
char      GUI_ColorIsAvailable(GUI_COLOR color);
GUI_COLOR GUI_Index2Color(I32 Index);
void      GUI_InitLUT(void);
void      GUI_SetLUTEntry (U8 Pos, GUI_COLOR Color);
void      GUI_SetLUTColor (U8 Pos, GUI_COLOR Color);
void      GUI_SetLUTColorEx(U8 Pos, LCD_COLOR Color, U32 LayerIndex);
...
I32  GUI_BMP_Draw         (const void * pFileData, I32 x0, I32 y0);
I32  GUI_BMP_GetXSize     (const void * pFileData);
I32  GUI_BMP_GetYSize     (const void * pFileData);
void GUI_Clear            (void);
void GUI_ClearRect        (I32 x0, I32 y0, I32 x1, I32 y1);
void GUI_ClearRectEx      (const GUI_RECT* pRect);
void GUI_DrawArc          (I32 x0, I32 y0, I32 rx, I32 ry, I32 a0, I32 a1);
void GUI_DrawBitmap       (const GUI_BITMAP GUI_UNI_PTR * pBM, I32 x0, I32 y0);
void GUI_DrawBitmapMag    (const GUI_BITMAP GUI_UNI_PTR * pBM, I32 x0, I32 y0, I32 XMul, I32 YMul);
void GUI_DrawBitmapEx     (const GUI_BITMAP GUI_UNI_PTR * pBitmap, I32 x0, I32 y0, I32 xCenter, I32 yCenter, I32 xMag, I32 yMag);
void GUI_DrawBitmapExp    (I32 x0, I32 y0, I32 XSize, I32 YSize, I32 XMul,  I32 YMul, I32 BitsPerPixel, I32 BytesPerLine, const U8 GUI_UNI_PTR * pData, const GUI_LOGPALETTE GUI_UNI_PTR * pPal);
void GUI_DrawCircle       (I32 x0, I32 y0, I32 r);
void GUI_DrawEllipse      (I32 x0, I32 y0, I32 rx, I32 ry);
void GUI_DrawGraph        (I16 *pay, I32 NumPoints, I32 x0, I32 y0);
void GUI_DrawGraphEx      (I16 *pay, I32 NumPoints, I32 x0, I32 y0, I32 Numerator, I32 Denominator);
void GUI_DrawHLine        (I32 y0, I32 x0, I32 x1);
void GUI_DrawLine         (I32 x0, I32 y0, I32 x1, I32 y1);
void GUI_DrawLineRel      (I32 dx, I32 dy);
void GUI_DrawLineTo       (I32 x, I32 y);
void GUI_DrawPie          (I32 x0, I32 y0, I32 r, I32 a0, I32 a1, I32 Type);
void GUI_DrawPixel        (I32 x, I32 y);
void GUI_DrawPoint        (I32 x, I32 y);
void GUI_DrawPolygon      (const GUI_POINT* pPoints, I32 NumPoints, I32 x0, I32 y0);
void GUI_DrawPolyLine     (const GUI_POINT* pPoints, I32 NumPoints, I32 x0, I32 y0);
void GUI_DrawFocusRect    (const GUI_RECT *pRect, I32 Dist);
void GUI_DrawRect         (I32 x0, I32 y0, I32 x1, I32 y1);
void GUI_DrawRectEx       (const GUI_RECT *pRect);
void GUI_DrawVLine        (I32 x0, I32 y0, I32 y1);
void GUI_FillCircle       (I32 x0, I32 y0, I32 r);
void GUI_FillEllipse      (I32 x0, I32 y0, I32 rx, I32 ry);
void GUI_FillPolygon      (const GUI_POINT* pPoints, I32 NumPoints, I32 x0, I32 y0);
...
typedef I32 GUI_JPEG_GET_DATA_FUNC(void * p, I32 MaxNumBytes, const U8 ** ppData, unsigned StartOfFile);

I32  GUI_JPEG_Draw        (const void * pFileData, I32 DataSize, I32 x0, I32 y0);
I32  GUI_JPEG_DrawEx      (GUI_JPEG_GET_DATA_FUNC * fpGetData, void * p, I32 x0, I32 y0);
I32  GUI_JPEG_DrawScaled  (const void * pFileData, I32 DataSize, I32 x0, I32 y0, I32 Num, I32 Denom);
I32  GUI_JPEG_DrawScaledEx(GUI_JPEG_GET_DATA_FUNC * fpGetData, void * p, I32 x0, I32 y0, I32 Num, I32 Denom);
I32  GUI_JPEG_GetInfo     (const void * pFileData, I32 DataSize, GUI_JPEG_INFO* pInfo);
I32  GUI_JPEG_GetInfoEx   (GUI_JPEG_GET_DATA_FUNC * fpGetData, void * p, GUI_JPEG_INFO * pInfo);
...
void  GUI_DispChars (U16 c, I32 Cnt);
void  GUI_DispCharAt(U16 c, I16P x, I16P y);
void  GUI_DispString         (const char GUI_UNI_PTR *s);
void  GUI_DispStringAt       (const char GUI_UNI_PTR *s, I32 x, I32 y);
void  GUI_DispStringAtCEOL   (const char GUI_UNI_PTR *s, I32 x, I32 y);
void  GUI_DispStringHCenterAt(const char GUI_UNI_PTR *s, I32 x, I32 y);
void  GUI__DispStringInRect  (const char GUI_UNI_PTR *s, GUI_RECT* pRect, I32 TextAlign, I32 MaxNumChars);
void  GUI_DispStringInRect   (const char GUI_UNI_PTR *s, GUI_RECT* pRect, I32 Flags);
#if GUI_SUPPORT_ROTATION
  void  GUI_DispStringInRectEx (const char GUI_UNI_PTR *s, GUI_RECT* pRect, I32 TextAlign, I32 MaxLen, const GUI_ROTATION * pLCD_Api);
#endif
void  GUI_DispStringInRectMax(const char GUI_UNI_PTR *s, GUI_RECT* pRect, I32 TextAlign, I32 MaxLen); /* Not to be doc. */
void  GUI_DispStringInRectWrap(const char GUI_UNI_PTR *s, GUI_RECT* pRect, I32 TextAlign, GUI_WRAPMODE WrapMode); /* Not to be doc. */
void  GUI_DispStringLen      (const char GUI_UNI_PTR *s, I32 Len);
void  GUI_GetTextExtend(GUI_RECT* pRect, const char GUI_UNI_PTR * s, I32 Len);
I32   GUI_GetYAdjust(void);
I32   GUI_GetDispPosX(void);
I32   GUI_GetDispPosY(void);
const GUI_FONT GUI_UNI_PTR * GUI_GetFont(void);
I32   GUI_GetCharDistX(U16 c);
I32   GUI_GetStringDistX(const char GUI_UNI_PTR *s);
GUI_DRAWMODE GUI_GetDrawMode(void);
I32   GUI_GetFontDistY(void);
I32   GUI_GetFontSizeY(void);
void  GUI_GetFontInfo   (const GUI_FONT GUI_UNI_PTR * pFont, GUI_FONTINFO* pfi);
void  GUI_GetOrg(I32 * px, I32 * py);
I32   GUI_GetYSizeOfFont(const GUI_FONT GUI_UNI_PTR * pFont);
I32   GUI_GetYDistOfFont(const GUI_FONT GUI_UNI_PTR * pFont);
I32   GUI_GetTextAlign(void);
I32   GUI_GetTextMode(void);
char  GUI_IsInFont(const GUI_FONT GUI_UNI_PTR * pFont, U16 c);
I32   GUI_SetTextAlign(I32 Align);
I32   GUI_SetTextMode(I32 Mode);
...
void               GUI_ALLOC_FreePtrArray(GUI_HMEM * pArray, I32 NumElems);
...
void GUI_MagnifyPolygon(GUI_POINT* pDest, const GUI_POINT* pSrc, I32 NumPoints, I32 Mag);
void GUI_EnlargePolygon(GUI_POINT* pDest, const GUI_POINT* pSrc, I32 NumPoints, I32 Len);
...
*************************************************************
*/
void GUI_DrawStreamedBitmap(const GUI_BITMAP_STREAM *pBitmapStream, I32 x, I32 y);
...
void GUI_BMP_SerializeEx(GUI_CALLBACK_VOID_U8_P * pfSerialize, I32 x0, I32 y0, I32 xSize, I32 ySize, void * p);
...
I32  GUI_Exec(void);         /* Execute all jobs ... Return 0 if nothing was done. */
I32  GUI_Exec1(void);        /* Execute one job  ... Return 0 if nothing was done. */
...
*/
I32     GUI_MessageBox   (const char * sMessage, const char * sCaption, I32 Flags);
...
I32  GUI_AA_GetFactor        (void);
void GUI_AA_SetFactor        (I32 Factor);
void GUI_AA_DrawArc          (I32 x0, I32 y0, I32 rx, I32 ry, I32 a0, I32 a1);
void GUI_AA_DrawLine         (I32 x0, I32 y0, I32 x1, I32 y1);
void GUI_AA_DrawPolyOutline  (const GUI_POINT * pSrc, I32 NumPoints, I32 Thickness, I32 x, I32 y);
void GUI_AA_DrawPolyOutlineEx(const GUI_POINT * pSrc, I32 NumPoints, I32 Thickness, I32 x, I32 y, GUI_POINT * pBuffer);
void GUI_AA_FillCircle       (I32 x0, I32 y0, I32 r);
void GUI_AA_FillPolygon      (GUI_POINT* pPoints, I32 NumPoints, I32 x0, I32 y0);

/**************************************************************************
 * RECT Process
 ************************************************************************
 * */
#define GUI_RectIntersect		WM_RectIntersect
#define GUI_RectIntersectLCD	WM_RectIntersectLCD
#define GUI_RectIsIn			WM_RectIsIn
#define GUI_RectSet			WM_RectSet
...
/* Message layer */
void GUI_StoreKeyMsg(I32 Key, I32 Pressed);
void GUI_SendKeyMsg (I32 Key, I32 Pressed);
I32  GUI_PollKeyMsg(void);

/* Message hook */
typedef I32 GUI_KEY_MSG_HOOK(I32 Key, I32 Pressed);
extern  GUI_KEY_MSG_HOOK* GUI_pfKeyMsgHook;
GUI_KEY_MSG_HOOK* GUI_SetKeyMsgHook(GUI_KEY_MSG_HOOK* pHook);

/* Application layer */
I32  GUI_GetKey(void);
I32  GUI_WaitKey(void);
void GUI_StoreKey(I32 c);
...
*        Mouse, generic
*/
I32  GUI_MOUSE_GetState  (      GUI_PID_STATE *pState);
...
I32  GUI_TOUCH_GetState     (GUI_PID_STATE *pState);
void GUI_TOUCH_GetUnstable  (I32* px, I32* py);  /* for diagnostics only */
void GUI_TOUCH_StoreState   (I32 x, I32 y);
void GUI_TOUCH_StoreStateEx (const GUI_PID_STATE *pState);
void GUI_TOUCH_StoreUnstable(I32 x, I32 y);
...
I32  GUI_TOUCH_X_MeasureX(void);
I32  GUI_TOUCH_X_MeasureY(void);
...
extern const uctGUI_SIF_APIList GUI_SIF_APIList_Prop_AA4;
