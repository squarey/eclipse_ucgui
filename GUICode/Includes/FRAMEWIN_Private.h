...
void            FRAMEWIN__UpdateButtons   (FRAMEWIN_Obj* pObj, I32 OldHeight);
...
void            FRAMEWIN_MinButtonSetState(WM_HWIN hButton, I32 State);
void            FRAMEWIN_MaxButtonSetState(WM_HWIN hButton, I32 State);
