...
*       _SetPixel
*/
static void _SetPixelIndex(I32 x, LCD_PIXELINDEX ColorIndex) {
  _SetRGB(ColorIndex);
...
*       _InitBM
*/
static void _InitBM(I32 xsize, I32 x0) {
  _Bm.XSize        = xsize;
  _Bm.YSize        = 1;
...
*       _DrawBitLine1BPP
*/
static void _DrawBitLine1BPP(I32 x, U8 const GUI_UNI_PTR * p, I32 Diff, I32 xsize, const LCD_PIXELINDEX * pTrans) {
  I32 xx;
  ...
  case LCD_DRAWMODE_XOR:;
    do {
  		if (*p & (0x80 >> Diff)) {
        I32 Pixel = LCD_L0_GetPixelIndex(xx, _y);
...
*       _DrawBitLine2BPP
*/
static void _DrawBitLine2BPP(I32 x, U8 const GUI_UNI_PTR * p, I32 Diff, I32 xsize, const LCD_PIXELINDEX * pTrans) {
  I32 xx;
...
*       _DrawBitLine4BPP
*/
static void _DrawBitLine4BPP(I32 x, U8 const GUI_UNI_PTR * p, I32 Diff, I32 xsize, const LCD_PIXELINDEX * pTrans) {
  I32 xx;
  U8 Pixels = *p;
  I32 CurrentPixel = Diff;
  x += Diff;
...
*       _DrawBitLine8BPP
*/
static void _DrawBitLine8BPP(I32 x, U8 const GUI_UNI_PTR * p, I32 xsize, const LCD_PIXELINDEX * pTrans) {
  I32 xx = x;
...
*       _DrawBitLine16BPP
*/
static void _DrawBitLine16BPP(I32 x, U16 const GUI_UNI_PTR * p, I32 xsize, const LCD_PIXELINDEX * pTrans) {
  I32 xx = x;
  LCD_PIXELINDEX pixel;
...
*/
void LCD_L0_DELTA_DrawBitmap(I32 x0, I32 y0,
                             I32 xsize, I32 ysize,
                             I32 BitsPerPixel, 
                             I32 BytesPerLine,
...
*/
void LCD_L0_DELTA_DrawHLine(I32 x0, I32 y,  I32 x1) {
...
*/
void LCD_L0_DELTA_SetPixelIndex(I32 x, I32 y, I32 ColorIndex) {
