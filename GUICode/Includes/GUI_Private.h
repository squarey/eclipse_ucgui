...
void LCD_L0_DrawBitmap    (I32 x0, I32 y0, I32 xsize, I32 ysize, 
                           I32 BitsPerPixel, I32 BytesPerLine, 
                           const U8 GUI_UNI_PTR * pData, I32 Diff, const LCD_PIXELINDEX* pTrans);
void LCD_L0_1_DrawBitmap  (I32 x0, I32 y0, I32 xsize, I32 ysize, 
                           I32 BitsPerPixel, I32 BytesPerLine, 
                           const U8 GUI_UNI_PTR * pData, I32 Diff, const LCD_PIXELINDEX* pTrans);
void LCD_L0_2_DrawBitmap  (I32 x0, I32 y0, I32 xsize, I32 ysize, 
                           I32 BitsPerPixel, I32 BytesPerLine, 
                           const U8 GUI_UNI_PTR * pData, I32 Diff, const LCD_PIXELINDEX* pTrans);
void LCD_L0_3_DrawBitmap  (I32 x0, I32 y0, I32 xsize, I32 ysize, 
                           I32 BitsPerPixel, I32 BytesPerLine, 
                           const U8 GUI_UNI_PTR * pData, I32 Diff, const LCD_PIXELINDEX* pTrans);
void LCD_L0_4_DrawBitmap  (I32 x0, I32 y0, I32 xsize, I32 ysize, 
                           I32 BitsPerPixel, I32 BytesPerLine, 
                           const U8 GUI_UNI_PTR * pData, I32 Diff, const LCD_PIXELINDEX* pTrans);
void LCD_L0_MAG_DrawBitmap(I32 x0, I32 y0, I32 xsize, I32 ysize, 
                           I32 BitsPerPixel, I32 BytesPerLine, 
                           const U8 GUI_UNI_PTR * pData, I32 Diff, const LCD_PIXELINDEX* pTrans);
void LCD_L0_DELTA_DrawBitmap(I32 x0, I32 y0, I32 xsize, I32 ysize, 
                           I32 BitsPerPixel, I32 BytesPerLine, 
                           const U8 GUI_UNI_PTR * pData, I32 Diff, const LCD_PIXELINDEX* pTrans);
