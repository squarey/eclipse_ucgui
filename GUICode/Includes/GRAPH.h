...
GRAPH_Handle GRAPH_CreateEx      (I32 x0, I32 y0, I32 xsize, I32 ysize, WM_HWIN hParent, I32 WinFlags, I32 ExFlags, I32 Id);
GRAPH_Handle GRAPH_CreateIndirect(const GUI_WIDGET_CREATE_INFO* pCreateInfo, WM_HWIN hWinParent, I32 x0, I32 y0, WM_CALLBACK* cb);
...
GRAPH_SCALE_Handle GRAPH_SCALE_Create  (I32 Pos, I32 TextAlign, unsigned Flags, unsigned TickDist);
...
void      GRAPH_SetUserDraw  (GRAPH_Handle hObj, void (* pOwnerDraw)(WM_HWIN hObj, I32 Stage));

void GRAPH_DATA_YT_AddValue(GRAPH_DATA_Handle hDataObj, I16 Value);
void GRAPH_DATA_YT_SetAlign(GRAPH_DATA_Handle hDataObj, I32 Value);
void GRAPH_DATA_YT_SetOffY (GRAPH_DATA_Handle hDataObj, I32 Off);
...
void GRAPH_DATA_XY_SetOffX     (GRAPH_DATA_Handle hDataObj, I32 Off);
void GRAPH_DATA_XY_SetOffY     (GRAPH_DATA_Handle hDataObj, I32 Off);
...
I32                          GRAPH_SCALE_SetNumDecs   (GRAPH_SCALE_Handle hScaleObj, I32 NumDecs);
I32                          GRAPH_SCALE_SetOff       (GRAPH_SCALE_Handle hScaleObj, I32 Off);
I32                          GRAPH_SCALE_SetPos       (GRAPH_SCALE_Handle hScaleObj, I32 Pos);
