...
*       _GetColorIndex
*/
static I32 _GetColorIndex(I32 i)  /* i is 0 or 1 */
{
...
void LCD_DrawPixel(I32 x, I32 y)
{
	if (GUI_Context.DrawMode & LCD_DRAWMODE_XOR) {
		...
		LCDDEV_L0_SetPixelIndex(x, y, LCD_COLORINDEX, GUI_Context.Alpha);
	}
}
...
*       LCD_DrawHLine
*/
void LCD_DrawHLine(I32 x0, I32 y,  I32 x1)
{
	if (x1 < x0){
		return;
	}
...
*       LCD_DrawBitmap
*/
void LCD_DrawBitmap(I32 x0, I32 y0, I32 xsize, I32 ysize, I32 xMul, I32 yMul,
...
void LCD_SetColor(GUI_COLOR color) {
	if (GUI_Context.Color != color) {
		...
		GUI_Context.Alpha = (color >> 24) & 0xff;
