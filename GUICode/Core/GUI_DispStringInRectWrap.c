...
*/
void GUI_DispStringInRectWrap(const char GUI_UNI_PTR * s, GUI_RECT * pRect, I32 TextAlign, GUI_WRAPMODE WrapMode)
{
	const GUI_RECT * pOldClipRect;
	GUI_RECT Rect;
	I32 xSize, ySizeFont, NumBytesToNextLine, NumCharsDisp;
	if (!s) {
		return;
	}
	Rect      = *pRect;
