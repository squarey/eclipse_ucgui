...
*       _IsLineEnd
*/
static I32 _IsLineEnd(U16 Char) {
  if (!Char || (Char == '\n')) {
    return 1;
  }
  return 0;
...
*       _GetNoWrap
*/
static I32 _GetNoWrap(const char GUI_UNI_PTR * s) {
...
*/
static I32 _GetWordWrap(const char GUI_UNI_PTR * s, I32 xSize, I32 * pxDist) {
  I32 xDist = 0, NumChars = 0, WordWrap = 0, CharDist = 0;
  U16 Char;
  I32 IgnoreNextCharacter = 0, CharIsArabic;
...
*/
static I32 _GetCharWrap(const char GUI_UNI_PTR * s, I32 xSize) {
  I32 xDist = 0, NumChars = 0;
  U16 Char;
  I32 IgnoreNextCharacter = 0, CharIsArabic;
...
*/
static I32 _WrapGetNumCharsDisp(const char GUI_UNI_PTR * pText, I32 xSize, GUI_WRAPMODE WrapMode, I32 * pxDist) {
  I32 r;
  switch (WrapMode) {
...
I32 GUI__WrapGetNumCharsToNextLine(const char GUI_UNI_PTR * pText, I32 xSize, GUI_WRAPMODE WrapMode) {
  ...
  if (Char == '\n') {
    ...
    if ((WrapMode == GUI_WRAPMODE_WORD) && (Char == ' ')) {
      I32 xDistChar = GUI_GetCharDistX(Char);
