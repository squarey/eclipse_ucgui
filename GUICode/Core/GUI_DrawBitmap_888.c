...
*       _DrawBitmap
*/
static void _DrawBitmap(I32 x0, I32 y0, I32 xsize, I32 ysize, const U8 GUI_UNI_PTR * pPixel, const LCD_LOGPALETTE GUI_UNI_PTR * pLogPal, I32 xMag, I32 yMag, tLCDDEV_Index2Color * pfIndex2Color)
{
	const U32 * pData;
	I32 y, OldIndex, Mag, BytesPerLine, UseDrawBitmap = 0;
	U32 PrevColor;
		...
		if (Mag == 1) {
			...
			for (y = 0; y < ysize; y++) {
				...
				for (x = 0; x < xsize; x++) {
					...
					LCDDEV_L0_SetPixelIndex(x + x0, y + y0, LCD_COLORINDEX, 0xff);
				}
...
*       _DrawBitmap_565
*/
static void _DrawBitmap_888(I32 x0, I32 y0, I32 xsize, I32 ysize, const U8 GUI_UNI_PTR * pPixel, const LCD_LOGPALETTE GUI_UNI_PTR * pLogPal, I32 xMag, I32 yMag)
{
...
*       _DrawBitmap_M565
*/
static void _DrawBitmap_M888(I32 x0, I32 y0, I32 xsize, I32 ysize, const U8 GUI_UNI_PTR * pPixel, const LCD_LOGPALETTE GUI_UNI_PTR * pLogPal, I32 xMag, I32 yMag)
{
