...
*/
static void _TransformPointCCW(I32 * pXPos, I32 * pYPos) {
...
*       _DrawBitmapCCW
*/
static void _DrawBitmapCCW(I32 x0, I32 y0, I32 xsize, I32 ysize, I32 xMul, I32 yMul,
                           ...
                           const U8 GUI_UNI_PTR * pPixel, const LCD_PIXELINDEX* pTrans)
{
  ...
  if ((xMul == 1) && (yMul == 1)) {
    ...
    if (x1 > GUI_Context.ClipRect.x1) {
      I32 Diff = x1 - GUI_Context.ClipRect.x1;
      ysize -= Diff;
    }
    /* Clip left side */
    if (x0 < GUI_Context.ClipRect.x0) {
      I32 Diff = GUI_Context.ClipRect.x0 - x0;
