...
*       _GetTableIndex
*/
static I32 _GetTableIndex(U16 c) {
  if (c < 0x621) {
    return 0;
  }
  if (c > 0x6cc) {
...
*       _IsTransparent
*/
static I32 _IsTransparent(U16 c) {
  if (c >= 0x064b) {
    return 1;
  }
  if (c == 0x670) {
...
*       _GetLigature
*/
static I32 _GetLigature(U16 Char, U16 Next, I32 PrevAffectsJoining) {
...
*/
static I32 _GetStringDistXArabic(const char GUI_UNI_PTR *s, I32 MaxNumChars) {
  U16 Glyph, Char, PrevChar = 0, NextChar;
  I32 CharIsArabic, IgnoreNextCharacter = 0, xSizeArabic = 0;
  while (--MaxNumChars >= 0) {
    if (!PrevChar) {
...
U16 GUI__GetCursorCharacterArabic(const char GUI_UNI_PTR * s, I32 Index, I32 MaxNumChars, I32 * pIsRTL) {
  I32 Ligature = 0, PrevIndex, PrevAffectsJoining;
...
U16 GUI__GetPresentationForm(U16 Char, U16 Next, U16 Prev, I32 * pIgnoreNext) {
  I32 CharIndex, PrevIndex, NextAffectsJoining, PrevAffectsJoining, Final, Initial, Medial, Ligature;
...
I32 GUI__GetLineDistXArabic(const char GUI_UNI_PTR *s, I32 MaxNumChars) {
  ...
  if (s) {
    U16 Glyph, Char, PrevChar = 0, NextChar;
    I32 CharIsArabic, IgnoreNextCharacter = 0;
...
void GUI__DispLineArabic(const char GUI_UNI_PTR * s, I32 MaxNumChars, const GUI_RECT * pRect) {
  ...
  #endif
    U16 Glyph, Char, PrevChar = 0, NextChar;
    I32 CharIsArabic, xPosArabicStart, IgnoreNextCharacter = 0, xSizeArabic;
...
I32 GUI__GetCursorPosXArabic(const char GUI_UNI_PTR * s, I32 Index, I32 MaxNumChars) {
  ...
  I32 CharIsArabic, ArabicMode = 0, IgnoreNextCharacter = 0, xSizeArabic, CursorPosXArabic = 0, LigaturPosition;
  const char GUI_UNI_PTR * p;
  const char GUI_UNI_PTR * pNext;
  while (--MaxNumChars >= 0) {
    if (!PrevChar) {
...
I32 GUI__GetCursorPosCharArabic(const char GUI_UNI_PTR * s, I32 x, I32 MaxNumChars) {
  ...
  I32 CharIsArabic, ArabicMode = 0, IgnoreNextCharacter = 0, xSizeArabic, CursorPosXArabic = 0, CharWidth, NewPosX;
  const char GUI_UNI_PTR * p;
  const char GUI_UNI_PTR * pNext;
