...
#define CHECKBOX_USE_SCHEME_SMALL	1
#define CHECKBOX_USE_SCHEME_MEDIUM  0
#define CHECKBOX_USE_SCHEME_LARGE	0
/*********************************************************************
*
*       Static const data
*
...
#elif CHECKBOX_USE_SCHEME_MEDIUM
static const unsigned char _acCheck[] = {
  ________, ________,
  ________, ________,
  ________, ________,
...
#elif CHECKBOX_USE_SCHEME_LARGE
static const unsigned char _acCheck[] = {
