...
**********************************************************************
*/
FRAMEWIN_Handle FRAMEWIN_Create        (const char* pTitle, WM_CALLBACK* cb, I32 Flags, I32 x0, I32 y0, I32 xsize, I32 ysize);
FRAMEWIN_Handle FRAMEWIN_CreateAsChild (I32 x0, I32 y0, I32 xsize, I32 ysize, WM_HWIN hParent, const char* pText, WM_CALLBACK* cb, I32 Flags);
FRAMEWIN_Handle FRAMEWIN_CreateIndirect(const GUI_WIDGET_CREATE_INFO* pCreateInfo, WM_HWIN hWinParent, I32 x0, I32 y0, WM_CALLBACK* cb);
FRAMEWIN_Handle FRAMEWIN_CreateEx      (I32 x0, I32 y0, I32 xsize, I32 ysize, WM_HWIN hParent,
                                        I32 WinFlags, I32 ExFlags, I32 Id, const char* pTitle, WM_CALLBACK* cb);
...
WM_HWIN FRAMEWIN_AddButton     (FRAMEWIN_Handle hObj, I32 Flags, I32 Off, I32 Id);
WM_HWIN FRAMEWIN_AddCloseButton(FRAMEWIN_Handle hObj, I32 Flags, I32 Off);
WM_HWIN FRAMEWIN_AddMaxButton  (FRAMEWIN_Handle hObj, I32 Flags, I32 Off);
void    FRAMEWIN_AddMenu       (FRAMEWIN_Handle hObj, WM_HWIN hMenu);
WM_HWIN FRAMEWIN_AddMinButton  (FRAMEWIN_Handle hObj, I32 Flags, I32 Off);
...
**********************************************************************
*/
void FRAMEWIN_SetActive      (FRAMEWIN_Handle hObj, I32 State);
...
void FRAMEWIN_SetMoveable    (FRAMEWIN_Handle hObj, I32 State);
void FRAMEWIN_SetResizeable  (FRAMEWIN_Handle hObj, I32 State);
void FRAMEWIN_SetText        (FRAMEWIN_Handle hObj, const char* s);
void FRAMEWIN_SetTextAlign   (FRAMEWIN_Handle hObj, I32 Align);
...
void FRAMEWIN_SetTitleVis    (FRAMEWIN_Handle hObj, I32 Show);
...
**********************************************************************
*/
I32 FRAMEWIN_GetTitleHeight (FRAMEWIN_Handle hObj);
I32 FRAMEWIN_GetBorderSize  (FRAMEWIN_Handle hObj);
I32 FRAMEWIN_IsMinimized    (FRAMEWIN_Handle hObj);
I32 FRAMEWIN_IsMaximized    (FRAMEWIN_Handle hObj);
...
I32             FRAMEWIN_GetDefaultBorderSize (void);
I32             FRAMEWIN_GetDefaultTitleHeight(void);
...
void            FRAMEWIN_SetDefaultBorderSize (I32 DefaultBorderSize);
void            FRAMEWIN_SetDefaultTitleHeight(I32 DefaultTitleHeight);
void            FRAMEWIN_SetDefaultClientColor(GUI_COLOR Color);
void            FRAMEWIN_SetDefaultFont       (const GUI_FONT GUI_UNI_PTR * pFont);
I32             FRAMEWIN_SetDefaultTextAlign  (I32 TextAlign);
