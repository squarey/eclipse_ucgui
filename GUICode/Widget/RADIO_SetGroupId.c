...
*       _SetValue
*/
static void _SetValue(RADIO_Handle hObj, I32 v) {
  RADIO_Obj* pObj;
  pObj = RADIO_H2P(hObj);
...
*       _IsInGroup
*/
static I32 _IsInGroup(WM_HWIN hWin, U8 GroupId) {
  if (GroupId) {
    WM_MESSAGE Msg;
...
*       _HandleSetValue
*/
static void _HandleSetValue(RADIO_Handle hObj, RADIO_Obj* pObj, I32 v) {
  if (v < 0) {
