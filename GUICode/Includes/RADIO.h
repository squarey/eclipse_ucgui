...
RADIO_Handle RADIO_CreateEx      (I32 x0, I32 y0, I32 xsize, I32 ysize, WM_HWIN hParent,
                                  I32 WinFlags, I32 ExFlags, I32 Id, I32 NumItems, I32 Spacing);
...
void      RADIO_SetDefaultImage     (const GUI_BITMAP * pBitmap, U32 Index);
...
void      RADIO_AddValue     (RADIO_Handle hObj, I32 Add);
...
void      RADIO_SetImage     (RADIO_Handle hObj, const GUI_BITMAP * pBitmap, U32 Index);
...
void      RADIO_SetValue     (RADIO_Handle hObj, I32 v);
...
**********************************************************************
*/
I32 RADIO_GetValue(RADIO_Handle hObj);
