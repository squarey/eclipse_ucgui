...
struct EDIT_Obj_struct {
  ...
  I32 CursorPos;           /* Cursor position. 0 means left most */
  ...
  U8 Flags;
  U8 CursorBlink;			/* 1: To Enable cursor blink  0: Disable cursor blink*/
  uctEDIT_AddKeyEx     * pfAddKeyEx;     /* Handle key input */
  uctEDIT_UpdateBuffer * pfUpdateBuffer;  /* Update textbuffer */
  EDIT_PROPS Props;
