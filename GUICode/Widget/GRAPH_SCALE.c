...
*/
  ...
  #define GRAPH_SCALE_TEXTCOLOR_DEFAULT GUI_WHITE
    ...
    #define GRAPH_SCALE_FONT_DEFAULT GUI_DEFAULT_FONT
#endif
...
static void _OnPaintVert(GRAPH_SCALE_OBJ * pScaleObj, GUI_RECT * pRectInvalid) {
  I32 BorderT, BorderB, EffectSize;
  GRAPH_OBJ * pObj;
  I32 xPos, xPosScreen, y0, y1, i, yStart, FontSizeY, TextOffY;
  GUI_RECT Rect;
...
static void _OnPaintHorz(GRAPH_SCALE_OBJ * pScaleObj, GUI_RECT * pRectInvalid) {
  I32 BorderL, BorderR, EffectSize;
  GRAPH_OBJ * pObj;
  I32 yPos, yPosScreen, x0, x1, i, xStart, FontSizeY, xAdd;
  GUI_RECT Rect;
  if (!pScaleObj->TickDist) {
    return;
  }
