...
*       _GetVect
*/
static void _GetVect(tfPoint* pfPoint, const GUI_POINT* pSrc, I32 NumPoints, I32 Index) {
  I32 Off0 = (Index + NumPoints-1) % NumPoints;
  I32 Off1 = Index % NumPoints;
