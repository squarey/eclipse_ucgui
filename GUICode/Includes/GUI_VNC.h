...
**********************************************************************
*/
typedef I32 (*GUI_tSend)   (const U8 * pData, I32 len, void* pConnectInfo);
typedef I32 (*GUI_tReceive)(      U8 * pData, I32 len, void* pConnectInfo);
...
typedef struct GUI_VNC_CONTEXT {
  ...
  I32 x0Dirty, y0Dirty, x1Dirty, y1Dirty;
  I32 XSize, YSize;
  /* Status */
...
**********************************************************************
*/
I32  GUI_VNC_Process      (GUI_VNC_CONTEXT* pContext, GUI_tSend pfSend, GUI_tReceive pfReceive, void* pConnectInfo);
void GUI_VNC_AttachToLayer(GUI_VNC_CONTEXT* pContext, I32 LayerIndex);
I32  GUI_VNC_GetNumConnections(void);

/****  External routine to link the server to the system ... USER defined ! ****/
I32  GUI_VNC_X_StartServer(I32 LayerIndex, I32 ServerIndex);
